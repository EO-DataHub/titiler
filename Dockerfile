...
RUN python -m pip install /tmp/titiler/core /tmp/titiler/xarray[full] /tmp/titiler/extensions /tmp/titiler/mosaic /tmp/titiler/application --no-cache-dir --upgrade
...
ENV TITILER_API_DEBUG=true
ENV TITILER_API_LOG_LEVEL=debug
ENV CPL_DEBUG=ON
